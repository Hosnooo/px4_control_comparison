...
/**
 * Vehicle-specific measured affine normalization support.
 *
 * Calibration records must identify measured hardware, remain within their accepted age and fit
 * limits, and cover the normalized thrust/torque request. Failed provenance, range, inversion, or
 * physical-wrench reconstruction checks fail closed and never yield an accepted PX4 command.
 */
