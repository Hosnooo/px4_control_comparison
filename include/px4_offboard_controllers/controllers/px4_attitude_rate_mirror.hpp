...
/**
 * ROS-independent mirror of the audited PX4 multicopter attitude and rate loops.
 *
 * Attitude input is NED<-FRD and rate input is FRD rad/s. The rate stage additionally requires
 * measured angular acceleration, armed/landed state, saturation direction and dt. Output is
 * normalized FRD torque/thrust for PX4's allocator. Reduced-attitude/yaw weighting, PX4 dt
 * clamping, integration inhibition, yaw filtering and optional battery scaling are preserved.
 */
