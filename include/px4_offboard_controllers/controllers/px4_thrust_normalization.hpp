...
// PX4's CONSTANTS_ONE_G at the audited revision.
...
/**
 * Frozen PX4 multicopter acceleration-to-thrust normalization mirror.
 *
 * Input is m/s^2 in NED. Output includes final saturated NED thrust direction and the equivalent
 * negative body-Z FRD collective command. This class mirrors PX4 gravity/tilt/thrust limiting but
 * has no ROS or message dependency.
 */
